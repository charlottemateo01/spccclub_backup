...
<body class="sidebar-show">
  <div id="app">
    <div class="main-wrapper">
      <div class="nav-bg" style=" background-image: url(http://localhost/spcc_club/assets/images/clubbanner/1653365081278786254_499111441665798_5038019153379424598_n.png)"></div>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <img alt="image" src="<?=base_url('assets/images/teacher_profile/').$teacherData['picture']?>" class="rounded-circle mr-1">
            ...
            <div class="dropdown-menu dropdown-menu-right ">
              ...
              <a href="teacherlogout" class="dropdown-item has-icon text-danger">
      ...
      <div class="main-sidebar" tabindex="1" style="overflow: hidden; outline: none;">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class=""><a class="nav-link" href="clubwork"><i class="fas fa-user-graduate"></i><span>clubWorks</span></a></li>
